...
#FlexureTower.Shape BRIK 1.429 0.5715 5.3785

#FlexureTower.Copy FlexureTower1
#FlexureTower1.Position 0.0 0.0 {-CryostatOuterZ-2*CryoBaseStageZ-CryoBaseZ}
#FlexureTower1.Mother Cryostat_Base
...
DHB_AlongXMiddleDown.Shape BRIK DHB_AlongX_HalfSizeX DHB_HalfWidth  DHB_HalfHeight
DHB_AlongXMiddleDown.Position { 0.0 } { 0.0 } {ColdfingerBasePosZ-CryoLidZ+0.5*CryostatXYFullThickness}
...
# Believe my CAD model is wrong because this is a complete overlap. Removing for now
#Volume DHB_DetSidePost
#DHB_DetSidePost.Material al7075
#DHB_DetSidePost.Visibility 1
#DHB_DetSidePost.Color 2
...
#DHB_SkewBase.Shape BRIK 0.216 0.2285 0.5395

#DHB_SkewBase.Copy DHB_SkewBase1
#DHB_SkewBase1.Position {DHB_CentStrucBase_HalfWidth+0.5715+.5715-.216} {0.3685+0.2285} {ColdfingerBasePosZ+DHB_HalfHeight+0.5395-CryoLidZ+0.5*CryostatXYFullThickness}
#DHB_SkewBase1.Mother Cryostat_Interior

#DHB_SkewBase.Copy DHB_SkewBase2
#DHB_SkewBase2.Position {DHB_CentStrucBase_HalfWidth+0.5715+.5715-.216} {-0.3685-0.2285} {ColdfingerBasePosZ+DHB_HalfHeight+0.5395-CryoLidZ+0.5*CryostatXYFullThickness}
#DHB_SkewBase2.Mother Cryostat_Interior

#DHB_SkewBase.Copy DHB_SkewBase3
#DHB_SkewBase3.Position {-DHB_CentStrucBase_HalfWidth-0.5715-.5715+.216} {-0.3685-0.2285} {ColdfingerBasePosZ+DHB_HalfHeight+0.5395-CryoLidZ+0.5*CryostatXYFullThickness}
#DHB_SkewBase3.Mother Cryostat_Interior

#DHB_SkewBase.Copy DHB_SkewBase4
#DHB_SkewBase4.Position {-DHB_CentStrucBase_HalfWidth-0.5715-.5715+.216} {0.3685+0.2285} {ColdfingerBasePosZ+DHB_HalfHeight+0.5395-CryoLidZ+0.5*CryostatXYFullThickness}
...
DHB_Skewer.Color 7
DHB_Skewer.Shape TUBS 0.0 0.1425 4.972 0.0 360.0

DHB_Skewer.Copy DHB_Skewer1
DHB_Skewer1.Position {DHB_CentStrucBase_HalfWidth+0.5715+.5715-.216} {0.3685+0.2285} {ColdfingerBasePosZ+DHB_HalfHeight+2*0.5395+4.972-CryoLidZ+0.5*CryostatXYFullThickness}
DHB_Skewer1.Mother Cryostat_Interior

DHB_Skewer.Copy DHB_Skewer2
DHB_Skewer2.Position {DHB_CentStrucBase_HalfWidth+0.5715+.5715-.216} {-0.3685-0.2285} {ColdfingerBasePosZ+DHB_HalfHeight+2*0.5395+4.972-CryoLidZ+0.5*CryostatXYFullThickness}
DHB_Skewer2.Mother Cryostat_Interior

DHB_Skewer.Copy DHB_Skewer3
DHB_Skewer3.Position {-DHB_CentStrucBase_HalfWidth-0.5715-.5715+.216} {-0.3685-0.2285} {ColdfingerBasePosZ+DHB_HalfHeight+2*0.5395+4.972-CryoLidZ+0.5*CryostatXYFullThickness}
DHB_Skewer3.Mother Cryostat_Interior

DHB_Skewer.Copy DHB_Skewer4
DHB_Skewer4.Position {-DHB_CentStrucBase_HalfWidth-0.5715-0.5715+0.216} {0.3685+0.2285} {ColdfingerBasePosZ+DHB_HalfHeight+2*0.5395+4.972-CryoLidZ+0.5*CryostatXYFullThickness}
...
Rod_Hole1.Parameters 0.0 0.15 0.11 0.0 360.0
...
Rod_Hole2.Parameters 0.0 0.15 0.11 0.0 360.0
...
Rod_Hole3.Parameters 0.0 0.15 0.11 0.0 360.0
...
Rod_Hole4.Parameters 0.0 0.15 0.11 0.0 360.0
...
For Z  NLayers  { DetZPos }  {2.5660}
   ...
   SingleDetector_Copy%Z_b.Position {DetX + DetXHalfGap} {-(DetY+DetYHalfGap)} {$Z-.4}
   ...
   SingleDetector_Copy%Z_c.Position {-DetX - DetXHalfGap} {DetY+DetYHalfGap} {$Z-.4}
...
#IRShieldBottom.Position 0 0 { IRShieldPosZ -DHB_HalfHeight}
